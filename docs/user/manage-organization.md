...
![Capabilities illustration](../assets/images/update-user-capabilities.png)
...
![Remove user illustration](../assets/images/remove-user.png)
...
![See notifications illustration](../assets/images/see-notifications.png)
